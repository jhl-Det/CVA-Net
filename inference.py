...
def get_args_parser():
    ...
    parser.add_argument('--self_attn', default=True, action='store_true')
    ...
    parser.add_argument('--ckpt', default='/opt/tiger/prt_det/CVA-Net/run/self_attn_exp8/checkpoint0042.pth', help='resume from checkpoint')
